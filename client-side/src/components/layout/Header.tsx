    ...
    <header className="border-gold-200/40 bg-background sticky top-0 z-50 border-b shadow-sm">
      <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between px-4">
        <Link href="/" className="group relative flex items-center gap-2.5">
          <CornerFlourish
            corner="tl"
            className="pointer-events-none -top-3 -left-3 size-6 opacity-0 transition-opacity duration-150 group-hover:opacity-100"
          />
          <span className="ring-gold-300/40 flex size-9 items-center justify-center rounded-full bg-primary text-primary-foreground ring-1 transition-colors duration-150 group-hover:ring-2 group-hover:ring-gold-400/70">
          ...
          {user ? (
            <>
              ...
              <button
                ...
                className="border-border hover:border-primary/50 hover:text-primary flex items-center gap-1.5 rounded-full border px-4 py-2 text-sm font-medium transition-colors duration-150"
              >
            ...
            <Link
              href="/auth"
              className="ring-gold-300/50 bg-primary hover:bg-primary/90 rounded-full px-5 py-2 text-sm font-semibold text-primary-foreground ring-1 transition-colors duration-150 hover:ring-2 hover:ring-gold-400/70"
            >
              Войти
            </Link>
          )}
